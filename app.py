...
html_temp = """
		...
		<h1 style="color:white;text-align:center;">Hepatitis B virus Mortality Predictor </h1>
		<h5 style="color:white;text-align:center;">HBV MORTAILTY PREDICTION USING ML </h5>
		</div>
		"""

# Avatar Image using a url
avatar1 ="images/male_avtar.png"
avatar2 ="images/female_avtar.png"

result_temp ="""
	<div style="background-color:#464e5f;padding:10px;border-radius:10px;margin:10px;">
	<h4 style="color:white;text-align:center;">Algorithm:: {}</h4>
	<img src="images/male_avtar.png" alt="Avatar" style="vertical-align: middle;float:left;width: 50px;height: 50px;border-radius: 50%;" >
	<br/>
	<br/>	
...
result_temp2 ="""
	<div style="background-color:#464e5f;padding:10px;border-radius:10px;margin:10px;">
	<h4 style="color:white;text-align:center;">Algorithm:: {}</h4>
	<img src="images/female_avtar.png{}" alt="Avatar" style="vertical-align: middle;float:left;width: 50px;height: 50px;border-radius: 50%;" >
	<br/>
	<br/>	
	<p style="text-align:justify;color:white">{} % probalibilty that Patient {}s</p>
	</div>
...
def main():
	##"""HBV MORTAILTY Prediction"""
	##st.title("HBV MORTAILTY Prediction App")
	...
	if choice == "Home":
		...
		st.image(load_image('images/iw.jpeg'))
		...
		if st.sidebar.checkbox("Login"):
			...
			if result:
				...
				if activity == "Plot":
					...
					# niche wala display in array format
					st.write(len(feature_list))

					st.write(feature_list)
					# display it in full format with value and key
